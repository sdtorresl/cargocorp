...
<section class="about-us">
    <div class="d-flex justify-content-center">
        <h3 class="trititle d-inlie-flex">Sobre nosotros</h3>
    </div>
    <div>
        <h2 class="about-us-title">
            Somos un Managing General Agent (MGA) especializado
        </h2>
        <p class="about-us-text">
            Somos un Managing General Agent (MGA) especializado en proveer capacidad para las líneas de Marine (Cargo, STP, Project Cargo, Casco, P&I, RC Marítimas) y Terrorismo.
    ...
    <div class="our-team-slide">
        <div class="container paddings">
            <div class="row justify-content-center">
                <div class="col-10 col-sm-10 col-md-4 col-lg-3 col-xl-3 justify-content-right">
                    <figure>
                        <?= $this->Html->image('team-member-image.png', ['alt' => 'team-member-photo']); ?>
                    </figure>
                </div>
                <div class="col-10 col-sm-10 col-md-6 col-lg-6 col-xl-6 team-slide">
                    ...
                    <a href="#" class="team-member-email">Enviar correo </a>
                </div>
            </div>
        </div>
        <div class="container paddings">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-11 col-sm-11 col-md-11 col-lg-11 col-xl-11 p-0">
                <div class="d-flex justify-content-center" id="movil-style">
            ...
            <div class="row">
                <div class="col-10 col-sm-10 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div class="contact-information">
                        ...
                        <p class="contact-text">
                            Phone: (305) 433 6492 / (305) 433 6342
                        </p>
                        <p class="contact-text">
                            Phone: (57) 1 317 502 5065 Fax: (305) 728 5278
                        </p>
                    </div>
                    <div class="mapouter"><div class="gmap_canvas">
                        <iframe width="564" height="371" id="gmap_canvas" src="https://maps.google.com/maps?q=701%20Brickell%20Avenue&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                        <a href="https://getasearch.com/fmovies"></a>
                        <br>
                        <style>.mapouter{position:relative;text-align:right;height:371px;width:564px;}</style>
                        <a href="https://www.embedgooglemap.net">add google map</a>
                        <style>.gmap_canvas {overflow:hidden;background:none!important;height:371px;width:564px;}
                        </style></div>
                    </div>
                </div>
                <div class="col-10 col-sm-10 col-md-6 col-lg-6 col-xl-6 contact-col">
                    <p class="contact-title">
                        México
                    </p>
                    <div class="contact-information">
                    ...
                    <div class="mapouter"><div class="gmap_canvas">
                        <iframe width="471" height="276" id="gmap_canvas" src="https://maps.google.com/maps?q=Arist%C3%B3teles%20N%C2%B0%2077&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://getasearch.com/fmovies"></a><br><style>.mapouter{position:relative;text-align:right;height:276px;width:471px;}</style><a href="https://www.embedgooglemap.net">add google map</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:276px;width:471px;}</style></div>
                    </div>
                </div>
            </div>
        </div>
